...
public class TuikeTimeUtils {
	...
	public static float getBeApartHour(String startTime, String endTime, int num){
		Date end = TuikeTimeUtils.getConversionFormatDateByString(endTime, num);
		Date start = TuikeTimeUtils.getConversionFormatDateByString(startTime, num);
