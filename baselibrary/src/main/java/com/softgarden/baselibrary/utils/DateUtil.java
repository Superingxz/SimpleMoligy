...
public class DateUtil {
    ...
    public static String FORMAT_YMDHM2 = "yyyy.MM.dd HH:mm";
    ...
    /**
     * 中文+英文全称  如：2016年12月01日  23时15分06秒
     */
    public static String FORMAT_YMDHMS_CN_EN = "yyyy年MM月dd日  HH:mm:ss";
    public static String FORMAT_YMDHMS_CN_EN_NO_SECOND = "yyyy年MM月dd日  HH:mm";
     ...
     * @return
     */
    public static String getFormatStr(long time, String format) {
        if (time < 9999999999L) {
            time = time * 1000L;
        }
    ...
    public static Calendar str2CalendarDay(String str) {
        return str2Calendar(str, null);
    }
    ...
    public static String secToTime(long endTime) {
        String timeStr = null;
        long hour = 0;
        long minute = 0;
        long second = 0;
    ...
    public static String fromNow(long time) {
        if (time > 9999999999L) {//1494813237
            time = time / 1000L;
        }
        ...
        if (ago <= 0)
            ...
            return getFormatStr(time, FORMAT_MD);
        }
