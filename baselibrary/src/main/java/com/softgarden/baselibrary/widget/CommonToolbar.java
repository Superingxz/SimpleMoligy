...
public class CommonToolbar extends Toolbar {
     ...
     * 显示文本菜单按钮
     */
    public void showTextLeft(CharSequence text) {
        mLeftTextView.setText(text);
        mLeftTextView.setVisibility(VISIBLE);
    }
     ...
     * @param text
     */
    public void showTextRight(CharSequence text) {
        mRightTextView.setText(text);
        mRightTextView.setVisibility(VISIBLE);
    }
    ...
    public static class Builder {
        ...
        private boolean isShowStatusBar = true;//是否显示StatusBar
        ...
        public Builder setTextLeft(CharSequence leftText) {
            this.leftText = leftText;
            return this;
        }

        public Builder setTextRight(CharSequence rightText) {
            this.rightText = rightText;
            return this;
        }
        ...
        public Builder isShowStatusBar(boolean isShowStatusBar){
        ...
        public CommonToolbar build(Context context) {
            ...
            if (!TextUtils.isEmpty(rightText)) {
                toolbar.showTextRight(rightText);
            }
