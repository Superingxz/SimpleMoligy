...
class ActivityTranslucentHelper {
    ...
    private static void convertActivityToTranslucentAfterL(Activity activity, PageTranslucentListener listener) {
        try {
            ...
            L.d(TAG, "convertActivityToTranslucentAfterL true");
        } catch (Throwable t) {
            L.e(TAG, "convertActivityToTranslucentAfterL error: " + t.getMessage());
            t.printStackTrace();
        }
    }
    ...
    private static void convertActivityToTranslucentBeforeL(Activity activity, PageTranslucentListener listener) {
        try {
            ...
            L.e(TAG, "convertActivityToTranslucentBeforeL error: " + t.getMessage());
            t.printStackTrace();
        }
    }
    ...
    public static boolean convertActivityFromTranslucent(Activity activity) {
        try {
            ...
            L.d(TAG, "convertActivityFromTranslucent true");
            return true;
        } catch (Throwable t) {
            L.e(TAG, "convertActivityFromTranslucent error: " + t.getMessage());
            t.printStackTrace();
            return false;
        }
    }
