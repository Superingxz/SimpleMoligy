...
import com.softgarden.simplemoligy.refresh.RefreshFragment;
 ...
 * Fragment基类 懒加载
 */
public abstract class AppBaseRefreshFragment<VM extends IBaseViewModel, B extends ViewDataBinding> extends RefreshFragment<VM, B> {
    @Override
