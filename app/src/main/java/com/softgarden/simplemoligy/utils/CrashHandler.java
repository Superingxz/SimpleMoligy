...
//		}.start();
	...
	private void saveCrashInfoFile(Throwable ex) {
		...
		String time = AppTimeUtils.getConversionFormatStringByDate(new Date(), 2);
		String fileName = "crash-" + time + ".txt";
		
		try {
			if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
				FileOutputStream fos = new FileOutputStream(Constants.CACHE_PATH.SD_LOG + "/" + fileName, true);
